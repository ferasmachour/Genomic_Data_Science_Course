...
### Home work
1. Make a scatter plot of RPL14 expression vs rnai gene dependency for Rhabdomyosarcoma Sarcoma.
...
**We can see that only 7 out of 19 cell lines have RNAi dependency data**
...
***We can see from the few chosen genes that there is a tendency that the genes with higher expression are also more essential for these cells.***
